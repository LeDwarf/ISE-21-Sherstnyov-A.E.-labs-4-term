<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormCustomers.aspx.cs" Inherits="AlexeysShopWebView.FormCustomers" %>
...
<body>
    ...
    <div>
        ...
        <asp:Button ID="ButtonUpd" runat="server" Text="Обновить" OnClick="ButtonUpd_Click" />
         <asp:GridView ID="dataGridView" runat="server"  ShowHeaderWhenEmpty="True" BackColor="White" BContractColor="#0477db" BContractWidth="3px" CellPadding="4" GridLines="Horizontal" BContractStyle="Double">
            <FooterStyle BackColor="White" ForeColor="#333333" />
            <HeaderStyle BackColor="#0477db" Font-Bold="True" ForeColor="White" />
            <PagerStyle BackColor="#0477db" ForeColor="White" HorizontalAlign="Center" />
